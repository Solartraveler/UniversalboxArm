...
#define FB_COLOR_RES_X 16
#define FB_COLOR_RES_Y 16
...
#define FB_COLOR_OUT_SET 0
#define FB_COLOR_OUT_CLEAR 0xFFFF
...
*/
#define FB_OUTPUTBLOCK_X 16
#define FB_OUTPUTBLOCK_Y 8
...
/*Define to transfer one output block by DMA, while another one is prepared.
  This doubles the required stack while speeding up the redraw.
*/
