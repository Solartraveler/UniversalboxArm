...
static FB_SCREENPOS_TYPE g_fbScaleX = 1;
static FB_SCREENPOS_TYPE g_fbScaleY = 1;

static FB_SCREENPOS_TYPE g_fbOffsetX = 0;
static FB_SCREENPOS_TYPE g_fbOffsetY = 0;
